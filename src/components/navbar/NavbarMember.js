        ...
        <div>
            <div className="navbar bg-primary justify-evenly px-10 py-5">
                ...
                <div className='gap-2'>
                    ...
                    <a className='btn bg-accent text-m px-10 hover:bg-[#d7ab43]'>เติม Aysel</a>
                    <div className='flex flex-row'>
                        <a className='textArea bg-primary text-m text-white'> 99999  </a>
                    ...
                    <div className='dropdown'>
                        <div tabIndex={0} role='button' className='btn border-none px-3 bg-primary text-white hover:bg-[#d7ab43]'> <RiAccountCircleLine size='40px' /> my profile</div>
                        <ul tabIndex={0} className='dropdown-content z-[1] menu p-2 border-none bg-info text-primary rounded-box w-full'>
