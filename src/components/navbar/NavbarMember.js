        ...
        <div>
            <div className="navbar bg-primary justify-evenly px-10 py-5">
                ...
                <div className='gap-2'>
                    ...
                    <div className='dropdown'>
                        <div tabIndex={0} role='button' className='btn border-none px-3 bg-primary text-white hover:bg-primary'> <img src={`${process.env.REACT_APP_ASSET}${data.avatar}`} width={32} height={32} className='rounded-box'/>{data.username}</div>
                        <ul tabIndex={0} className='dropdown-content z-[1] menu p-2 border-none bg-info text-primary rounded-box w-full'>
